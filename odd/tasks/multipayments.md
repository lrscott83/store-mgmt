...
- T2 — script VPS `18-20260918-Add-MultiPayments-Module.sql` (paridad 1:1 con la migración `20260918131144`; registrar en `__EFMigrationsHistory` con ProductVersion `8.0.3`, igual que el script 17 y el snapshot).
