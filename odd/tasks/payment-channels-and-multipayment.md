...
- **T24 — semillas inertes en tests**: algunos tests unitarios conservan las siembras `payments: [paymentRowOf(...)]` que agregó T21; ahora son inertes (la lista no monta sin el módulo). Se dejaron para no debilitar cobertura; se pueden limpiar en un pase aparte.
