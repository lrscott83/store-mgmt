...
- 2026-09-24 (cont. 2): el usuario pidió cerrar ese hueco → **T14 — cuadre multi-tienda alineado** (commit `a572f88a`, suite del agregador **15/15**). Con esto la normalización de método queda consistente en **seis** superficies: historial, órdenes de hoy, filtros, modal de edición, estadísticas de una tienda y cuadre multi-tienda. **Sin límites abiertos de normalización.**
