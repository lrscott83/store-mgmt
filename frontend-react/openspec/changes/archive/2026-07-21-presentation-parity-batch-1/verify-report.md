...
- `REGISTRATION.SUCCESS_REDIRECT` i18n key: confirmed fully removed from `es.ts`, zero remaining code references (only a leftover mention in a test _description string_, not a functional usage).
