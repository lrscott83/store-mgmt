        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <span
                ...
                data-testid="edit-product-price-prefix"
              >
                $
              </span>
              <input
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-cyan-500"
              data-testid="edit-product-order-input"
            />
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              data-testid="edit-product-active-checkbox"
            />
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="h-4 w-4 rounded border-gray-300 text-cyan-600"
              data-testid="edit-product-discount-checkbox"
            />
            <span className="text-xs font-medium text-gray-600">
