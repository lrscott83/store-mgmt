...
//
// SCOPE: the business entities of ONE store. It never touches `token`,
 ...
 * cannot abort the remaining ones. A partial wipe is a worse outcome than a
 * full one, but a far better outcome than "the first key threw and the
 * others are still there without anyone knowing which".
 *
