            ...
            <div className="absolute right-0 top-full z-50 mt-1 w-56 rounded-xl border border-gray-200 bg-white py-1 shadow-lg">
              ...
              <div className="flex items-center gap-2 border-b border-gray-100 px-4 py-2">
                ...
                <button
                  ...
                  // Distinct accessible name from the dropdown's text "Salir" button
                  // below — two same-named controls in one popup are ambiguous to
                  // assistive tech and to E2E role queries (strict mode).
                  aria-label={intl.formatMessage({ id: 'GENERAL.LOGOUT_ICON' })}
                >
