...
/**
 * Material `bar_chart` — characteristic glyph for the per-day "Resumen de ventas del día"
 * action-menu item in sales history (orders.tsx). Outline style, `BASE` size, matching the
 * other action-menu icons.
 */
...
/** Heroicons `magnifying-glass` — search/report-generation actions (Cuadre por fechas). */
