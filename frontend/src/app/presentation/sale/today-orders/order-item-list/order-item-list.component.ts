...
export class OrderItemListComponent implements OnInit {
  ...
  constructor(private shoppingCartService: ShoppingCartService, private translate: TranslateService, private orderService: OrderOfflineService) { }

  ngOnInit(): void {
  }

  deactivateOrder(order: Order) {
    this.orderService.deactivateOrder(order.id);
  }
