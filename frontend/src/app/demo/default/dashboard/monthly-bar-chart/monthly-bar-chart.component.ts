...
export class MonthlyBarChartComponent implements OnInit {
  ...
  public viewMode: 'week' | 'month' = 'week';
  public pageViewsData: number[] = [0, 86, 28, 115, 48, 210, 136];
  public sessionsData: number[] = [0, 43, 14, 56, 24, 105, 68];
  public categories: string[] = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  ...
  toggleActive(value: string) {
    this.viewMode = value as 'week' | 'month';
    ...
    //   }
    // ];
    this.pageViewsData = value === 'month' ? [76, 85, 101, 98, 87, 105, 91, 114, 94, 86, 115, 35] : [31, 40, 28, 51, 42, 109, 100];
    this.sessionsData = value === 'month' ? [110, 60, 150, 35, 60, 36, 26, 45, 65, 52, 53, 41] : [11, 32, 45, 32, 34, 52, 41];
    this.categories =
      value === 'month'
