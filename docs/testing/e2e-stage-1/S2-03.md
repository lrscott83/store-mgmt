...
- [ ] Un OwnerAdmin **sin** la feature `Stores` en `featureIds` es deslogueado y redirigido a `/login` (`loaders.ts:16-19,72-74`). Ver **H-8**.
...
**E2E frontend (Playwright) — PENDIENTE**
Las 7 aserciones. En `vitest`, `store-form.test.tsx:464` cubre "modo creación ⇒ picker interactivo", que es el lado opuesto.
