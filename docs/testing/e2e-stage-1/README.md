...
Los dos specs de rate-limit quedan fuera a propósito —gastan decenas de intentos— y corren con `pnpm test:e2e:rate-limit`. Su última corrida verde documentada es la del 2026-08-07 (`2 passed (12.1s)`); no la re-corrió esta sesión.
