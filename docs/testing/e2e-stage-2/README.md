...
|---|---|---|---|
| [S2-A1](S2-A1.md) | CRUD offline de productos | CRÍTICA | Crear, editar, eliminar productos contra localStorage cifrado |
| [S2-A2](S2-A2.md) | CRUD offline de categorías | CRÍTICA | Crear, editar, eliminar, reordenar categorías |
