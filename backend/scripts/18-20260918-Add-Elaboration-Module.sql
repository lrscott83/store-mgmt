-- =====================================================
-- 18: Add Elaboration module (id 16, paid price 3, 100% discount)
--     + features 120 (Recipes) and 121 (Elaborations) under module 16
--     + StorePlanModule rows: Superior (3) and VIP (4)
--     + assignment to existing ACTIVE stores on Superior/VIP plans (OwnerAdmin only)
-- EF migration: 20260918145355_Add-Elaboration-Module
-- Date: 2026-09-18
...
-- --- Catalog: Module 16 (Elaboración, paid, effective price 0) ---
INSERT INTO "Module" ("Id", "AvailableToStore", "DiscountPrice", "IsActive", "Name", "Order", "PercentDiscountPrice", "Price", "PriceIncluded")
VALUES (16, TRUE, 0, TRUE, 'Elaboración', 130, 100, 3, FALSE)
ON CONFLICT ("Id") DO NOTHING;

-- --- Catalog: Features 120 (Recipes) and 121 (Elaborations) under module 16 ---
INSERT INTO "Feature" ("Id", "AvailableToStore", "Description", "IsActive", "ModuleId", "Name", "Order")
VALUES (120, TRUE, 'Funcionalidad para gestionar las recetas de elaboración de productos', TRUE, 16, 'Recetas', 240),
       (121, TRUE, 'Funcionalidad para registrar elaboraciones con consumo de insumos y costo real', TRUE, 16, 'Elaboraciones', 241)
ON CONFLICT ("Id") DO NOTHING;

-- --- Plan assignment: module 16 for Superior (3) and VIP (4) ---
...
VALUES ('20260918145355_Add-Elaboration-Module', '8.0.3')
...
-- DELETE FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260918145355_Add-Elaboration-Module';
-- COMMIT;
-- =====================================================
