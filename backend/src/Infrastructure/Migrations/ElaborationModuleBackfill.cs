...
{
    /// <summary>
    /// Shared SQL for the Elaboration module (id 17) assignment to existing stores on
    /// Superior (3) and VIP (4) plans — the plans that include the module.
    /// Single source of truth: the EF migration, the VPS script (backend/scripts/19-*.sql),
