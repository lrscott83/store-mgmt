...
using Application.Features.ApplicationManagement.Tenants.Queries.GetStoreFeatures;
...
namespace WebApiTest.Controllers.v1
{
    ...
    public class TenantsController : BaseApiController
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetTenantFeaturesAsync([FromQuery] GetStoreFeaturesQuery query)
        {
