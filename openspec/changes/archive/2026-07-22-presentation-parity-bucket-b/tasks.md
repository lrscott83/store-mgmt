...
- [x] 2.1 RED: write test in `admin/owners/routes/owner-edit.test.tsx` (Tiendas tab section) asserting `StoreCardList` renders store cards, no `<h1>` with `STORES.LIST_TITLE` text, no "+ Agregar" fab within the tab.
