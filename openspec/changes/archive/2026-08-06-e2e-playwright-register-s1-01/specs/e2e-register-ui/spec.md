...
- [ ] REQ-1..REQ-5, REQ-7, REQ-8 corren en la corrida por defecto (`pnpm test:e2e` o equivalente)
- [ ] REQ-6 se satisface con un único registro real por corrida
- [ ] REQ-9 corre solo mediante su propio script, nunca en la corrida por defecto
- [ ] REQ-10 verificado manualmente por el usuario al agotar la cuota
- [ ] `register.test.tsx` permanece sin cambios (REQ-11)
- [ ] `smoke.spec.ts` y `api-health.spec.ts` permanecen sin cambios
